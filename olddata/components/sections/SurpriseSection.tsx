...
export const SurpriseSection = () => {
  ...
  return (
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-neon-pink/10 via-soft-lavender/20 to-princess-pink/15">
      {/* Fireworks Animation */}
      {showFireworks && (
      ...
      <div className="relative z-10 text-center px-4 max-w-5xl mx-auto">
        {showMessage && (
          <div className="fade-in">
            {/* Crown */}
            <div className="mb-8">
              <Crown className="w-20 h-20 mx-auto text-neon-pink animate-glow" />
            </div>

            {/* Main Surprise Message */}
            <div className="glass-card p-12 mb-8 hover-glow">
              <h1 className="text-3xl md:text-7xl font-bold mb-8 leading-tight">
                <span className="block princess-text animate-rainbow mb-4">Zoella,</span>
                <span className="block princess-text animate-glow mb-4">My Princess,</span>
                <span className="block text-2xl md:text-5xl princess-text animate-heartbeat">
                  You are my Forever 💍
                </span>
              </h1>
              ...
              <div className="flex justify-center mb-8">
                <Heart className="w-16 h-16 text-neon-pink animate-heartbeat mr-4" />
                <Diamond className="w-12 h-12 text-neon-purple animate-sparkle mt-2" />
                <Heart className="w-16 h-16 text-neon-pink animate-heartbeat ml-4" style={{animationDelay: '0.5s'}} />
              </div>
              ...
              <div className="space-y-6 text-lg md:text-xl text-foreground/90 leading-relaxed">
                ...
                <p className="princess-text text-2xl font-bold">
            ...
            <div className="glass-card p-8 mb-8 hover-glow">
              <div className="flex justify-center items-center mb-6">
                <Sparkles className="w-8 h-8 text-neon-pink animate-sparkle mr-4" />
                <span className="text-4xl animate-glow">💍</span>
                <Heart className="w-6 h-6 text-neon-purple animate-heartbeat mx-3" />
                <span className="text-4xl animate-glow">💍</span>
                <Sparkles className="w-8 h-8 text-neon-pink animate-sparkle ml-4" />
              </div>
            ...
            {/* Final Message */}
            <div className="glass-card p-10 hover-glow bg-gradient-princess">
              <Star className="w-12 h-12 mx-auto text-pearl-white animate-sparkle mb-6" />
              <p className="text-3xl font-bold text-pearl-white mb-6 leading-tight">
                Thank you for being the most incredible person in my life ✨
              </p>
              <p className="text-xl text-pearl-white/90 mb-4">
                I love you more than words could ever express
              </p>
              <p className="text-2xl font-bold text-pearl-white animate-glow">
