  ...
  return (
    ...
    {isOpen && (
      <div className="fixed inset-0 z-50 md:hidden">
        ...
        {/* Bottom Sheet */}
        <div className="absolute bottom-0 left-0 right-0 glass-card rounded-t-3xl p-4 animate-slideUp tap-highlight-transparent">
          {/* Handle */}
          <div className="w-12 h-1 bg-foreground/20 rounded-full mx-auto mb-4" />
          
          {/* Header */}
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg font-bold princess-text">Princess Actions</h3>
            <button 
              onClick={onClose}
          ...
          {/* Message Display */}
          {message && (
            <div className="mb-4 p-3 glass-card bg-gradient-princess text-center">
              <p className="text-pearl-white font-bold animate-fadeIn text-sm">{message}</p>
            </div>
          )}
            ...
            {quickActions.map((action) => {
              ...
              return (
                <button
                  ...
                  className="glass-card p-3 text-center hover-glow transition-all duration-300 touch-manipulation active:scale-95"
                >
                  <Icon className={`w-7 h-7 mx-auto mb-2 animate-sparkle ${action.color}`} />
          ...
          {/* Love Quote */}
          <div className="glass-card p-3 mb-4 text-center bg-gradient-princess">
            <p className="text-xs font-medium text-pearl-white italic">
